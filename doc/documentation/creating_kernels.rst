...
and found inside :code:`grakelx.kernels` sub-package, inherits the :code:`Kernel` class found there.
...
.. code-block:: python
    ...
    >>> from grakelx import GraphKernel, datasets
...
This package can be found inside :code:`grakelx/kernels/_c_functions`. There the user can find the following files.

::

    grakelx/kernels/_c_functions
                        ├── functions.cpp
                        ├── functions.pxd
                        ├── functions.pyx
                        ├── include
