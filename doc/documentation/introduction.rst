...
------------------------------------
A graph may contain node labels or node attributes. There is an *optional* attribute of :class:`grakelx.Graph` which allows us to assign labels or attributes to the nodes.
...
------------------------------------
A graph may contain edge labels or edge attributes. There is an *optional* attribute of :class:`grakelx.Graph` which allows us to assign labels or attributes to the edges.
...
Alternatively, we can directly create an instance of :class:`grakelx.kernels.ShortestPath` object as follows:
...
.. doctest::
    ...
    >>> from grakelx.kernels import WeisfeilerLehman, VertexHistogram
