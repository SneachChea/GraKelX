...
version = grakelx.__version__
# The full version, including alpha/beta/rc tags.
release = grakelx.__version__
...
latex_documents = [
    ("index", "grakelx.tex", "grakelx Documentation", "Yannis Siglidis", "manual"),
]
...
man_pages = [("index", "grakelx", "GraKeL Documentation", ["Yannis Siglidis"], 1)]
...
texinfo_documents = [
    ("index", "grakelx", "GraKeL Documentation", "Yannis Siglidis", "GraKeL", "A library for graph kernels.", "Machine-Learning"),
]
