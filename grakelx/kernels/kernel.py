...
from grakelx.kernels._c_functions import k_to_ij_rectangular, k_to_ij_triangular
from grakelx.utils import EPS
...
class Kernel(BaseEstimator, TransformerMixin):
    ...
    X : list
        ...
        Default format of the list objects is `grakelx.graph.graph`.
