...
from grakelx.graph import Graph, dijkstra
...
if __name__ == "__main__":
    ...
    mec.add_argument("--linear", help="choose a linear kernel", action="store_true")
    ...
    mec.add_argument("--bridge", help="choose a bridge kernel", action="store_true")
