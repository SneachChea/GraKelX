...
def main(user=False, cmd_env=False, use_mingw=False):
    ...
    if platform.system() in ["Linux", "Darwin"]:
        ...
        if use_mingw:
            ...
            check_call(
                ["echo", "the only valid system for installation of grakelx on Windows (because of cvxopt dependencies..)"]
            )
...
if __name__ == "__main__":
    ...
    if platform.system() == "Windows":
        ...
        meg.add_argument(
            "--cmd_env",
            help="define if python needs to find the correct environment for building in visual studio [windows]",
            action="store_true",
        )
